...
import com.adminminiinventario.adapter.StockAdapter;
...
public class Notificaciones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acrivity_notificaciones);
        ...
        recyclerView = findViewById(R.id.mostrar_casillas_stock);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new StockAdapter(this, productList);
    ...
    private void obtenerProductosDelNegocio(String negocio) {
        if (negocio != null) {
            db.collection("productos")
                    ...
                    .whereLessThan("cantidad", 10) // Agrega esta condición para filtrar por cantidad menor a 10
                    .get()
