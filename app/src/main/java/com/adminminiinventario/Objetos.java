...
import com.adminminiinventario.adapter.ObjetosAdapter;
...
public class Objetos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.mostrar_casillas_objetos);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new ObjetosAdapter(this, productList);
    ...
    private void obtenerProductosDelNegocio(String negocio) {
        if (negocio != null) {
            db.collection("productos")
                    .whereEqualTo("id_negocio", negocio.toLowerCase())// Filtra solo los productos sin fecha de vencimiento
                    .get()
                        ...
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if (nombre_producto != null && precio != null) {
                                    ...
                                    // Verifica si el documento no contiene el campo fechaVencimiento
                                    if (!document.contains("fechaVencimiento")) {
